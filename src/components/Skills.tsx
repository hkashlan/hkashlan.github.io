...
const skillCategories = [
  {
    ...
    icon: Globe,
    skills: ['React', 'Angular', 'TypeScript', 'Tailwind CSS', 'Daisyui', 'GraphQL' ],
    color: 'blue'
  },
  {
  ...
  },
  {
    title: 'DevOps & Cloud',
    icon: Layers,
    skills: ['AWS', 'Docker', 'Docker Compose', 'Kubernetes', 'CI/CD', 'Terraform', 'GitHub Actions'],
    color: 'orange'
  },
  {
  ...
  },
  {
    ...
    icon: Code2,
    skills: ['Microservices', 'System Design', 'DDD', 'SOLID', 'Design Patterns', 'API Design'],
    color: 'cyan'
  }
];
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-slate-600 max-w-2xl mx-auto">
            Two decades of hands-on experience across the entire technology stack,
            delivering enterprise-grade solutions and leading technical innovation.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
          {skillCategories.map((category, index) => {
            ...
            return (
              ...
              >
                <div className={`w-12 h-12 rounded-lg bg-gradient-to-br ${colorClasses[category.color as keyof typeof colorClasses]} flex items-center justify-center mb-4`}>
