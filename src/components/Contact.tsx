			...
			<div className="container mx-auto px-6">
				...
				>
					...
					<p className="text-slate-300 max-w-2xl mx-auto">
						Always open to discussing new opportunities, innovative projects, or
						just having a conversation about technology and software
						architecture.
					</p>
				</motion.div>
				...
				>
					<div className="inline-block bg-slate-800 rounded-xl p-8">
						...
						<p className="text-slate-300 mb-6 max-w-md">
							Currently available for senior technical leadership roles,
							consulting engagements, and exciting full-stack development
							projects.
						</p>
						<a
